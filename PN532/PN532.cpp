...
void PN532::PrintHexDump(const uint8_t *data, const uint32_t numBytes)
{
...
static unsigned short UpdateCrc14443(uint8_t ch, uint8_t *lpwCrc)
{
    ch = (ch ^ ((*lpwCrc) & 0x00FF));
    ch = (ch ^ (ch << 4));
    *lpwCrc = (*lpwCrc >> 8) ^ ( ch << 8) ^
              ( ch << 3) ^ ( ch >> 4);
    return (*lpwCrc);
}
                     ...
                     uint8_t *TransmitSecond)
{
  ...
  do {
    ...
    *TransmitFirst =  (wCrc & 0xFF);
    *TransmitSecond = ((wCrc >> 8) & 0xFF);
    return;
}

uint8_t PN532::noCRC(void)
{
   uint8_t response;
   pn532_packetbuffer[0] = PN532_COMMAND_WRITEREGISTER;
   pn532_packetbuffer[1] = 0x63; // HIADDR;
   pn532_packetbuffer[2] = 0x03; //LOWADDRwas 0x14 for timeout 50ms * 20 = 1 second
   pn532_packetbuffer[3] = 0x80;
   pn532_packetbuffer[4] = 0x63;
   pn532_packetbuffer[5] = 0x02;
...
{
    uint8_t response;
  pn532_packetbuffer[0] = 0x08;
   pn532_packetbuffer[1] = 0x63; // HIADDR;
   pn532_packetbuffer[2] = 0x03; //LOWADDRwas 0x14 for timeout 50ms * 20 = 1 second
   pn532_packetbuffer[3] = 0x00; //0x80
   pn532_packetbuffer[4] = 0x63;
   pn532_packetbuffer[5] = 0x02;
   pn532_packetbuffer[6] = 0x00; //0x80 
    ...
    pn532_packetbuffer[1] = 0x50;
    pn532_packetbuffer[2] = 0x00;
    pn532_packetbuffer[3] = 0x57;
    pn532_packetbuffer[4] = 0xCD;
//    pn532_packetbuffer[5] = 0x76;
//    pn532_packetbuffer[6] = 0x00;
    //ComputeCrc14443(0x6363, pn532_packetbuffer, 5, &crc1, &crc2);
    //ComputeCrc14443(0x6363, pn532_packetbuffer, 5, &pn532_packetbuffer[5], &pn532_packetbuffer[6]);
    //pn532_packetbuffer[5] = 0x40;
    //pn532_crc = iso14443a_crc(pn532_packetbuffer, 6, crc);
    //memcpy(pn532_packetbuffer[5],crc1,1);
    //memcpy(pn532_packetbuffer[6],crc2,1);
...
pn532_packetbuffer[0] = 0x08;
   pn532_packetbuffer[1] = 0x63; // HIADDR;
   pn532_packetbuffer[2] = 0x3D; //LOWADDRwas 0x14 for timeout 50ms * 20 = 1 second
   pn532_packetbuffer[3] = 0x07; //0x80
  ...
  if (HAL(writeCommand)(pn532_packetbuffer, 4)) {
    ...
    pn532_packetbuffer[0] = 0x42;
    pn532_packetbuffer[1] = 0x40;
    
//    pn532_packetbuffer[2] = 0xAA;
//    pn532_packetbuffer[3] = 0x00;
 ...
 if (HAL(writeCommand)(pn532_packetbuffer, 2)) {
   ...
   pn532_packetbuffer[1] = 0x63; // HIADDR;
   pn532_packetbuffer[2] = 0x3D; //LOWADDRwas 0x14 for timeout 50ms * 20 = 1 second
   pn532_packetbuffer[3] = 0x00; //0x00
    ...
    pn532_packetbuffer[0] = 0x42;
    pn532_packetbuffer[1] = 0x43;
//    pn532_packetbuffer[2] = 0xA7;
//    pn532_packetbuffer[3] = 0x00;
 ...
 pn532_packetbuffer[0] = 0x08;
   pn532_packetbuffer[1] = 0x63; // HIADDR;
   pn532_packetbuffer[2] = 0x02; //LOWADDRwas 0x14 for timeout 50ms * 20 = 1 second
   pn532_packetbuffer[3] = 0x80; //0x80
   pn532_packetbuffer[4] = 0x63;
   pn532_packetbuffer[5] = 0x03;
   pn532_packetbuffer[6] = 0x80; //0x80
...
*/
/**************************************************************************/
uint8_t PN532::getPower(void)
{
   uint8_t response;
   pn532_packetbuffer[0] = PN532_COMMAND_READREGISTER;
   pn532_packetbuffer[1] = 0x02; // HIADDR;
   pn532_packetbuffer[2] = 0xFF; //LOWADDRwas 0x14 for timeout 50ms * 20 = 1 second
...
bool PN532::SAMConfig(void)
{
    ...
    pn532_packetbuffer[2] = 0x01; //was 0x14 for timeout 50ms * 20 = 1 second
    pn532_packetbuffer[3] = 0x00; // was 0x01 use IRQ pin!
...
bool PN532::setPassiveActivationRetries(uint8_t maxRetries)
{
    ...
    pn532_packetbuffer[2] = 0x01; // MxRtyATR (default = 0xFF)
...
bool PN532::quickMifareResetN()
{
    ...
    if (HAL(quickreadResponse)(pn532_packetbuffer, sizeof(pn532_packetbuffer)) < 0) {
        return 0x0;
    }
...
uint8_t PN532::mifareclassic_AuthenticateBlock (uint8_t *uid, uint8_t uidLen, uint32_t blockNumber, uint8_t keyNumber, uint8_t *keyData)
{
    ...
    HAL(quickreadResponse)(pn532_packetbuffer, sizeof(pn532_packetbuffer));
