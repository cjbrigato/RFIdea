...
#define SPECIAL_COMMAND_UNLOCK_A	    (0x40)
#define SPECIAL_COMMAND_UNLOCK_B            (0x43)
...
public:
    ...
    bool quickMifareReset();
    bool quickMifareResetN();
    uint8_t noCRC();
    ...
    static void PrintHexDump(const uint8_t *data, const uint32_t numBytes);
